...
**<span className="text-[#E75E23]">Life.js</span>** is the first-ever **fullstack agent framework**. Think of it as <span className="opacity-50">«</span> _the Next.js for agents_ <span className="opacity-50">»</span>.
