...
export type GetTokenFunction = (roomName: string, participantId: string) => Promise<string>;
...
export const getToken = async <ProviderId extends keyof typeof serverTransportProviders>(
  ...
  let getTokenFunction: GetTokenFunction;
  if (provider === "livekit")
  ...
  return getTokenFunction(roomName, participantId);
};
